...
public class OpenCVFaceRecognizer {
	...
	public static void main(String[] args) {
        String trainingDir = "E:\\Akshay Files\\Project Data\\train";
      org.opencv.core.Mat testImage = Imgcodecs.imread("E:\\Akshay Files\\Project Data\\upload\\");
    ...
    //    FaceRecognizer faceRecognizer = createFisherFaceRecognizer();
        ...
        int prdictedLabel = faceRecognizer.predict(testImage);

        System.out.println("Predicted label: " + prdictedLabel);
    }

	private static Mat imread(String absolutePath) {
